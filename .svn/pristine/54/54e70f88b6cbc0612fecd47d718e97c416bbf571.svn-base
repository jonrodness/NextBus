...
public class BusLocation {
	 ...
	 * @param dest   destination
	 * @param time   time at which location was recorded
	 * @param vehicleNum   vehicle number of bus
	 */
	
	public BusLocation(BusRoute route, double lat, double lon, String dest, String time, String vehicleNum) {
		this.route = route;
		this.dest = dest;
		this.time = time;
		latlon = new LatLon(lat, lon);
	...
	/**
	 * Gets vehicle number of a bus location
	 * @return  vehicle number of a bus
	 */
